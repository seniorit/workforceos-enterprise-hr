...
export class PurgeDbModalComponent {
  ...
  public async executePurge() {
    ...
    try {
      ...
      const successMsg = '¡Base de datos purgada con éxito! Se eliminaron todos los registros y el sistema fue reiniciado a cero con el Super Administrador como único usuario.';
